...
public class ARToolKitMenuEditor : MonoBehaviour {
    ...
    private const  string VERSION               = MENU_PATH_BASE + "/artoolkitX for Unity Version 1.1";
    ...
    private const  string GET_TOOLS_MESSAGE     = "artoolkitX for Unity Version 1.1! <b>To make your own markers, you'll need to download our tools.</b>\n" +
