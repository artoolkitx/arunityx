...
public class ARToolKitMenuEditor : MonoBehaviour {
    ...
    private const  string TOOLS_MENU_PATH       = "artoolkitX/Download Tools";
    ...
    private const  string VERSION               = "artoolkitX/artoolkitX for Unity Version 1.0.0";
    ...
    private const  string GET_TOOLS_MESSAGE     = "artoolkitX for Unity Version 1.0.0! <b>To make your own markers, you'll need to download our tools.</b>\n" +
